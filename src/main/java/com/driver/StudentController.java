...
public class StudentController {
    ...
    public ResponseEntity<String> addTeacher(@RequestBody Teacher teacher){
        Teacher t = ss.createTeacher(teacher);
        return new ResponseEntity<>("New teacher added successfully", HttpStatus.CREATED);
    }

    @PutMapping("/add-student-teacher-pair")
    public ResponseEntity<String> addStudentTeacherPair(@RequestParam String student, @RequestParam String teacher){
        ss.pairStudentTeacher(student, teacher);
    ...
    public ResponseEntity<List<String>> getStudentsByTeacherName(@PathVariable String teacher){
        List<String> students = ss.getStudentByTeacherName(teacher); // Assign list of student by calling service layer method
    ...
    public ResponseEntity<String> deleteTeacherByName(@RequestParam String teacher){
        ss.deleteTeacherAndStudents(teacher);
